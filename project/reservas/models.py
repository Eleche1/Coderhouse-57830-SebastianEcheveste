...
class Reserva(models.Model):
    ...
    estado = models.CharField(
        max_length=15,
        choices=[('Libre', 'Libre'), ('Reservada', 'Reservada')],
        default='Reservada'
    )
    ...
    def clean(self):
        ...
        for reserva in reservas_existentes:
            ...
            if (
                self.hora_inicio < reserva.hora_inicio < hora_fin or
...
# Signal para crear o actualizar el perfil cuando se crea un usuario
